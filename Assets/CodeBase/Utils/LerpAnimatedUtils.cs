...
namespace PixelCrew.Utils
{
    ...
    {
        public static Coroutine LerpAnimated(this MonoBehaviour mb, float start, float end, float time, Action<float> onFrame)
        {
            return mb.StartCoroutine(Animate(start, end, time, onFrame));
        }
